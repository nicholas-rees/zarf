...
`
	...
	CmdToolsGenKeyShortFlagForce         = "Force overwrite of keyfiles -- no effect when running interactive"
	CmdToolsGenKeyShortFlagPassword      = "Private key password -- no effect when running interactive (default \"\")"
	CmdToolsGenKeyShortFlagPasswordStdin = "Take the password from stdin -- overrides `--password`; no effect when running interactive"
