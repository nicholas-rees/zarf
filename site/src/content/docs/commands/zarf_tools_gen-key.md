...
```
      --force                       Force overwrite of keyfiles -- no effect when running interactive
  -h, --help                        help for gen-key
      --interactive                 Interactively prompt for password
      --password string             Private key password -- no effect when running interactive (default "")
      --password-stdin --password   Take the password from stdin -- overrides --password; no effect when running interactive
```
